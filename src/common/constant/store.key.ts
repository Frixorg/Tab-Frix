...
import type { ClockSettings } from '@/layouts/widgets/timeAndDate/clock-display/clock-setting.interface'
import type { WigiPadDateSetting } from '@/layouts/widgets/timeAndDate/date-display/date-setting.interface'
